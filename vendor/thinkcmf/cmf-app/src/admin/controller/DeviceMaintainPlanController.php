...
class DeviceMaintainPlanController extends AdminBaseController
{
    ...
    public function plan()
    {
        ...
        $roles = Db::table("mk_device_maintain_plan")
                        ->alias("a")
    ...
    public function plan_addPost()
    {
        if ($this->request->isPost()) {
            ...
            $data['last_maintain_time'] = strtotime($data['last_maintain_time']);
            
            $linkModel = new DeviceMaintainPlanModel();
    ...
    public function plan_edit()
    {
        ...
        $order_goods = Db::table("mk_device_maintain_plan")
                        ->alias("a")
    ...
    public function plan_delete()
    {
        ...
        DeviceMaintainPlanModel::destroy($id);
        $this->success("删除成功！", url("DeviceMaintainPlan/plan",array('id'=>$device_id)));
    }
