...
class DeviceRunhuaPlanController extends AdminBaseController
{
    ...
    public function plan()
    {
        ...
        $roles = Db::table("mk_device_runhua_plan")
                        ->alias("a")
    ...
    public function plan_addPost()
    {
        if ($this->request->isPost()) {
            ...
            $data['last_runhua_time'] = strtotime($data['last_runhua_time']);
            $linkModel = new DeviceRunhuaPlanModel();
    ...
    public function plan_edit()
    {
        ...
        $order_goods = Db::table("mk_device_runhua_plan")
                        ->alias("a")
    ...
    public function plan_delete()
    {
        ...
        DeviceRunhuaPlanModel::destroy($id);
        $this->success("删除成功！", url("DeviceRunhuaPlan/plan",array('id'=>$device_id)));
    }
